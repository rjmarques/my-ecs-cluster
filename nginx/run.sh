...
(sleep 5 ; certbot --nginx -n --agree-tos --email contact@ricardomarques.dev --no-eff-email --expand -d ricardomarques.dev,www.ricardomarques.dev,something.ricardomarques.dev,solar.ricardomarques.dev --redirect) &
