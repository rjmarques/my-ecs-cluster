...
(sleep 5 ; certbot --nginx -n --agree-tos --email contact@ricardomarques.dev --no-eff-email --expand -d something.ricardomarques.dev,solar.ricardomarques.dev,wasmmandel.ricardomarques.dev --redirect) &
